...
public class AnalysisController {
    ...
    public BaseResponse<List<InterfaceInfoVO>> listTopInvokeInterfaceInfo() {
        ...
        interfaceInfoQueryWrapper.in("id",interfaceInfoIdMap.keySet());
        ...
        List<InterfaceInfoVO> collect = list.stream().map(interfaceInfo -> {
            ...
            int totalNumber = interfaceInfoIdMap.get(interfaceInfo.getId()).get(0).getTotalNum();
            interfaceInfoVO.setTotalNum(totalNumber);
