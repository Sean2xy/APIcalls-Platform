...
public class UserInterfaceInfoController {
    ...
    @GetMapping("/My/InterfaceInfoData")
    public BaseResponse<List<InterfaceInfoVO>> displayMyInterfaceInfo(HttpServletRequest request){
        ...
        List<InterfaceInfoVO> selfInterfaceDateVos = new ArrayList<>();
        for (UserInterfaceInfo userInterfaceInfo : list) {
            InterfaceInfoVO selfInterfaceDateVo = new InterfaceInfoVO();
            ...
            selfInterfaceDateVo.setName(name);
